...
@dataclass
class historyForgeExtension(FactoryExtension):
    """Add /historyforge endpoint to a TilerFactory."""
    ...
    def register(self, factory: BaseTilerFactory):  # noqa: C901
        ...
        def historyforge(  # noqa: C901
            ...
            """Return a HistoryForge-compliant WMS query for a single COG.

            This is a slightly altered copy of the WMS extension. The main difference is in
            layer acquisition: HistoryForge will include the layer name in the url path,
            and force layers=image in the params. This must be translated into a call to
            the proper COG here.

            See: https://github.com/historyforge/historyforge/blob/master/app/javascript/forge/wms.ts#L87
            ...
            if request_type.lower() == "getcapabilities":
                ...
                wms_url = factory.url_for(request, "historyforge")
